...
#define CIE_TESTRUNNER_INIT( sourceName ) \
    cie::utils::Logger cie::utils::STATIC_LOG_BLOCK::_logger( cie::TEST_OUTPUT_PATH / ("test_" + std::string(sourceName) + "_log.txt"), true );

#define CIE_CIE_TEST_CASE_INIT( testCaseName ) \
