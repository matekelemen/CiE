#ifndef CIE_CSG_UNION_OPERATOR_IMPL_HPP
#define CIE_CSG_UNION_OPERATOR_IMPL_HPP
...
template <Size Dimension, concepts::NumericType CoordinateType>
inline Bool
Union<Dimension,CoordinateType>::at( const typename Union<Dimension,CoordinateType>::point_type& r_point ) const
{
